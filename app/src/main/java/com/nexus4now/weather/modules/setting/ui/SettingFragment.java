...
import com.nexus4now.weather.base.BaseApplication;
import com.nexus4now.weather.common.ACache;
import com.nexus4now.weather.common.PLog;
import com.nexus4now.weather.common.utils.FileSizeUtil;
...
public class SettingFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mChangeUpdate.setSummary(mSetting.getAutoUpdate() == 0 ? "禁止自动更新" : "每" + mSetting.getAutoUpdate() + "小时更新");
    ...
    private void showUpdateDialog() {
        ...
        if (mSeekBar.getProgress() == 0){
            tvShowHour.setText(String.format("禁止自动更新"));
